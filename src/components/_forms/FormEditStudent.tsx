...
async function registerNewStudent(data: StudentData) {
  return await api.post("/account", data); // Ajuste a rota conforme sua API
}
      ...
      <div className="mt-8 flex justify-center">
        <div className="w-full max-w-4xl bg-white dark:bg-gray-800 shadow-lg p-6 overflow-y-auto max-h-[85vh]">
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-4 py-2 mt-1 border rounded-md border-gray-300 dark:text-white"
          >
            <option value="ALUNO">ALUNO</option>
          </select>

          <p className="text-base font-medium text-[#155DFC] mt-4">Status da Escola</p>
          <select
            name="status"
